Tags: [[githubtutorial]] [[EDL fundamentals]] 
Status: Complete
Date: 7/8/2024
...
![](5.%20Final%20Notes/output/attachment/GC.png)
...
Addressing these concerns, Otto Stern simply just combined the two models together. The Stern or "Helmholtz Layer" is simply suggesting ion's have a closest approach (based on radius) and outside of this region is the diffuse layer from the Gouy-Chapman model. ![](5.%20Final%20Notes/output/attachment/GCS.png)
### Assumptions
...
A summary of the three classical model are shown in the following.![](cap.png)
...
- [Classic Models of the interface between an electrode and an electrolyte](Classical Models of the Interface between an Electrode and an Electrolyte)
...
- [Classical MD simulation studying the anisotropic behavior of the dielectric constant at a Ag-Water interface]()
