...
$$ HA_{(aq)} \leftrightarrow A^-_{(aq)} + H^+_{(aq)} $$ where A$$^-$$ is the conjugate base of the acid and H$$^+$$ is the proton in solution. The equilibrium constant, Ka, is defined as:
